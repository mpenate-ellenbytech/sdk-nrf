...
if("${SB_CONFIG_SECURE_BOOT_SIGNING_KEY_FILE}" STREQUAL "")
  ...
  elseif(EXISTS {APPLICATION_CONFIG_DIR}/${SB_CONFIG_SECURE_BOOT_SIGNING_KEY_FILE})
    set(SIGNATURE_PRIVATE_KEY_FILE
      ${APPLICATION_CONFIG_DIR}/${SB_CONFIG_SECURE_BOOT_SIGNING_KEY_FILE})
  else()
    set(SIGNATURE_PRIVATE_KEY_FILE ${APP_DIR}/${SB_CONFIG_SECURE_BOOT_SIGNING_KEY_FILE})
  endif()
